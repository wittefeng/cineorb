...
export default function HomeBiz({ dataLibrary, topLibrary }: any) {
    ...
    <div className={styles.page}>
      <div>
        <div className={styles.first}>
          <div>
            <Video imageUrl={topLibrary[0].logo} id={topLibrary[0].id} />
            <TopTag number={1} />
          </div>
        </div>
        <div className={styles.ts}>
          <div>
            <Video imageUrl={topLibrary[1].logo} id={topLibrary[1].id} />

            <TopTag number={2} />
          </div>
          <div>
            <Video imageUrl={topLibrary[2].logo} id={topLibrary[2].id} />
            <TopTag number={3} />
          </div>
        </div>
      </div>
      {pageWidth > 0 && videoWidth > 1 && (
        <div>
